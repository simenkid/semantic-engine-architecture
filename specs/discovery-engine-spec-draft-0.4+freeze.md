# Discovery Engine Specification – Draft 0.4 (Refined)

> **Document ID:** discovery-engine-spec-draft-0.4  
> **Status:** Draft (v0.4, refined core)  
...
The following elements are intended to remain stable once DE v0.4 is adopted:
